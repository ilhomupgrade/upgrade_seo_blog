...
Формат ответа:
{
  ...
  "story": "авторский мини-разбор новости на 5-9 коротких абзацев. Все абзацы должны быть внутри ОДНОЙ JSON-строки, разделяй их символами \\n\\n. Раскрой: что произошло, конкретные детали продукта/компании/тарифов/сроков, кому доступно, что изменилось, какая была реакция, какой контекст стоит знать",
  "angle": "короткий авторский вывод на 1-2 предложения: главный сигнал, конфликт или последствие",
...
- story должен быть разбит на 5-9 коротких абзацев через пустую строку
...
- Каждый абзац должен быть коротким: 1-2 предложения, до 350 символов
- Общая длина текста после заголовка: примерно 1800-3200 знаков
- Дай максимум конкретики: цифры, даты, тарифы, лимиты, названия моделей, API, режимы, доступность, имена, реакцию пользователей или компании, если они есть в источниках
- Используй структуру мини-досье: факт -> детали -> доступность/сроки -> реакция -> контекст -> вывод
- Не вставляй HTML-ссылки в title, story или angle
